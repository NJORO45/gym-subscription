   ...
   <div class="grid grid-cols-1  sm:grid-cols-3 px-6 py-4 gap-2">
    ...
    <div class="justify-items-center">
        ...
        <div class="flex flex-col ">
            <input id="SubscriptioncsrtfToken" class="csrtfToken" type="text" value="" hidden >
            <input id="emailSubscription" type="email" placeholder="Your email" class="outline-none py-2 px-1 border-2 border-gray-200 my-2 rounded-md">
            <p id="subscriptionError" class="text-xs font-bold text-red-400"></p>
            <button id="emailSubscriptionBtn" class="bg-orange-500 px-4 py-2 text-white hover:bg-orange-600 rounded-full">Subscribe</button>
        </div>
        <p id="suggestionOpener" class="mt-4 cursor-pointer text-blue-700">💡 Drop a suggestion anytime!</p>
    </div>
   </div>

<!--suggestion box pupup form-->
<div id="suggestionPopup" class="hidden fixed z-40 inset-0 bg-black/50 flex  justify-center  h-full pb-2 overflow-y-auto">
    <div class="bg-white rounded-xl w-full max-w-md md:max-w-lg h-64 mt-20 px-4 py-2">
        ...
        <div class="flex h-auto flex-col space-y-2">
            <input id="sugestioncsrtfToken" class="csrtfToken" type="text" value="" hidden >
            <textarea id="suggestionText" class="border rounded-lg p-2 outline-none resize-none" name="" id="" rows="4" placeholder="Write your suggestion here .."></textarea>
            <p id="sugestionError" class="text-xs font-bold text-red-400"></p>
            <button id="suggestionBtn" class="bg-orange-400 px-2 py-2 rounded-full text-white ">Submit</button>
        </div>
    </div>
</div>
<!--register pupup form-->
