...
<div class="flex flex-col gap-4 pt-20 sm:pt-20  mx-4 pb-6">
    ...
    <div class="w-full mx-auto pt-0">
        <div class="flex justify-between">
            <h2 class=" text-gray-600 font-bold w-full text-center">Payments List</h2>
            ...
            <table class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="bg-gray-100 p-2 text-gray-500 whitespace-nowrap">Plan</th>
                        <th class="bg-gray-100 p-2 text-gray-500 whitespace-nowrap">Amount</th>
                        ...
                        <th class="bg-gray-100 p-2 text-gray-500 whitespace-nowrap"></th>
                        <th class="bg-gray-100 p-2 text-gray-500 whitespace-nowrap">Status</th>
                        <th class="bg-gray-100 p-2 text-gray-500 whitespace-nowrap">date</th>
