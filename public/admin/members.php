...
<div class="flex flex-col gap-4 pt-20 sm:pt-20  mx-4 pb-6">
    ...
    <div class="w-full mx-auto pt-0">
        <div class="flex justify-between">
            <h2 class=" text-gray-600 font-bold w-full text-center">Members List</h2>
            <i id="addMember" class="ri-add-fill text-orange-400 text-2xl font-bold transform transition hover:scale-105 hover:-translate-y-1 cursor-pointer hover:text-orange-600"></i>
        </div>
...
<div id="blacklistMemberpopup" class="fixed z-40 inset-0 bg-black/50 hidden  flex justify-center">
    <div class="bg-white rounded-xl w-full max-w-md mx-2 md:max-w-lg h-fit mt-20 px-4 py-2">
        <div class="w-full flex justify-end">
            <i id="blacklistMembercross" class="ri-close-large-line cursor-pointer inline-block text-xl text-orange-400 transform transition duration-200 hover:scale-125 hover:text-orange-600"></i>
        </div>
...
<div id="editMemberdata" class="fixed z-40 inset-0 bg-black/50   hidden flex justify-center">
    <div class="bg-white rounded-xl w-full max-w-md mx-2 md:max-w-lg h-fit mt-20 px-4 py-2">
        <div class="w-full flex justify-end">
            <i id="editMemberdataCross" class="ri-close-large-line cursor-pointer inline-block text-xl text-orange-400 transform transition duration-200 hover:scale-125 hover:text-orange-600"></i>
        </div>
        <h2 class="mb-2 font-semibold text-center text-2xl">Edit Details</h2>
        <div class="space-y-2">
            <div class="flex flex-col w-full gap-4">
                <label for="">Member number</label>
                <input id="editMemberId" type="number" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg" readonly>
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">First name</label>
                <input id="editmemberFname" type="text" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg " >
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Last Name</label>
                <input id="editmemberLname" type="text" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg" >
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Email</label>
                <input id="editmemberEmail" type="email" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg" >
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Tel</label>
                <input id="editMemberTel" type="number" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg" >
            </div>
        </div>
        <div class="flex flex-col py-2">
            <button id="editMemberdataBtn" class="bg-orange-400 px-2 py-2 rounded-full text-white hover:bg-orange-600">Save Changes</button>
        </div>
    </div>
</div>
<!--add new member pupup form-->
<div id="addNewMember" class="fixed z-40 inset-0 bg-black/50 flex hidden  overflow-y-auto justify-center">
    <div class="bg-white rounded-xl w-full max-w-md mx-2 md:max-w-lg h-fit mt-20 px-4 py-2">
        <div class="w-full flex justify-end">
            <i id="addNewMembercross" class="ri-close-large-line cursor-pointer inline-block text-xl text-orange-400 transform transition duration-200 hover:scale-125 hover:text-orange-600"></i>
        </div>
        <h2 class="mb-2 font-semibold text-center text-lg">Add New Member</h2>
        <div class="space-y-2">
            <div class="flex flex-col w-full gap-4">
                <label for="">First name</label>
                <input id="registerFname" type="text" placeholder="Your first name" class="border-2 outline-none px-2 py-1 rounded-lg " >
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Last Name</label>
                <input id="registerLname" type="text" placeholder="Your last name" class="border-2 outline-none px-2 py-1 rounded-lg" >
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Email</label>
                <input id="registerEmail" type="email" placeholder="your name" class="border-2 outline-none px-2 py-1 rounded-lg" >
                <p id="registerEmailError" class=" text-red-500 font-semibold"></p>
            </div>
            <div class="flex flex-col w-full gap-4">
                <label for="">Tel</label>
                <input id="registerTel" type="number" placeholder="Your tel" class="border-2 outline-none px-2 py-1 rounded-lg" >
                <p id="registerTelError" class=" text-red-500 font-semibold"></p>
            </div>
        </div>
        <div class="flex flex-col py-2">
            <button id="addNewMemberBtn" class="bg-orange-400 px-2 py-2 rounded-full text-white hover:bg-orange-600">Add New Member</button>
        </div>
    </div>
</div>
</body>
